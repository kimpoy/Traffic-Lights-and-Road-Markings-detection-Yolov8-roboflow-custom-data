...
# use this if it has a warning ultralytics.checks()
...
model = YOLO('best.pt')
model.classes = [0]
classNames = ["BrokenWhiteLine","BrokenYellowLine","DoubleWhiteLine","DoubleYellowLine","GreenLight","RedLight","SolidWhiteLine","SolidYellowLine","YellowLight"]
while True:
